  ...
  return (
    <div className="mb-6 bg-white rounded-2xl shadow-lg p-5 border border-gray-100">
      <div className="flex items-start justify-between gap-4">
        ...
        <Link
          href="/profile"
          className="px-3 py-2 rounded-lg bg-slate-100 text-slate-700 text-sm font-medium hover:bg-slate-200 transition-colors shrink-0"
        >
          调整设置
        </Link>
      </div>
      ...
      {hasControls && (
        <div className="mt-4">
          <button
            ...
            className="w-full flex items-center justify-between rounded-xl border border-gray-200 bg-gray-50 px-3 py-2 text-left hover:bg-gray-100 transition-colors"
